...
function cafe_elementor_logo_resizer() {
    ...
    $cafe_elementor_logo_resizer = get_theme_mod('cafe_elementor_logo_resizer');

	$cafe_elementor_theme_logo_size_css = '
		.custom-logo{
			height: '.esc_attr($cafe_elementor_logo_resizer).'px !important;
			width: '.esc_attr($cafe_elementor_logo_resizer).'px !important;
		}
	';
...
define('CAFE_ELEMENTOR_THEME_BUNDLE',__('https://www.wpelemento.com/elementor/wordpress-theme-bundle/','cafe-elementor'));
