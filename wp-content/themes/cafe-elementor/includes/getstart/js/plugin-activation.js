jQuery(document).ready(function($) {
    'use strict';
    var this_obj = cafe_elementor_plugin_activate_plugin;

    $('#wpelemento_importer_editor .plugin-activation-redirect a').addClass('wpi-redirect-to-dashboard');

    $(document).on('click', '.cafe-elementor-plugin-install', function(event) {
        ...
        wp.updates.installPlugin({
            ...
            success: function(data) {
                ...
                button.removeClass('button-secondary updating-message cafe-elementor-plugin-install');
                button.addClass('button-primary cafe-elementor-plugin-activate');
                button.trigger('click');
            },
            error: function(data) {
                jQuery('.cafe-elementor-recommended-plugins .cafe-elementor-activation-note').css('display','block');
    ...
    $(document).on('click', '.cafe-elementor-plugin-activate', function(event) {
