jQuery(document).ready(function($) {
    'use strict';
    var this_obj = software_company_elementor_plugin_activate_plugin;

    $('#wpelemento_importer_editor .plugin-activation-redirect a').addClass('wpi-redirect-to-dashboard');

    $(document).on('click', '.software-company-elementor-plugin-install', function(event) {
        ...
        wp.updates.installPlugin({
            ...
            success: function(data) {
                ...
                button.removeClass('button-secondary updating-message software-company-elementor-plugin-install');
                button.addClass('button-primary software-company-elementor-plugin-activate');
                button.trigger('click');
            },
            error: function(data) {
                jQuery('.software-company-elementor-recommended-plugins .software-company-elementor-activation-note').css('display','block');
    ...
    $(document).on('click', '.software-company-elementor-plugin-activate', function(event) {
